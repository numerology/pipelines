...
_project_id = data_types.RuntimeParameter(
    name='project-id', ptype=Text, default='jxzheng-helloworld'
)
...
_gcp_region = data_types.RuntimeParameter(
    name='gcp-region', ptype=Text, default='us-central1'
)
...
beam_staging_dir = data_types.RuntimeParameter(
    name='beam-staging-dir',
    ptype=Text,
    default='gs://jxzheng-helloworld-kubeflow2-bucket/beam-staging'
)
_beam_pipeline_args = [
    '--runner=DataflowRunner',
    '--experiments=shuffle_mode=auto',
    '--project=' + str(_project_id),
    '--temp_location=' + os.path.join(str(beam_staging_dir), 'tmp'),
